...
with 
	DIM1 as (
		SELECT 
			FA.Id, FA.Type, FA.Amount, DV.Value as value1, 
	...
	DIM2 as (
		SELECT 
			FA.Id, FA.Type, FA.Amount, DV.Value as value2, 
	...
	DIM3 as (
		SELECT 
			FA.Id, FA.Type, FA.Amount, DV.Value as value3, 
...
select 
	D1.Amount, D1.Type, 
	D1.dimId1, D1.dimension1, D1.LevelId1, D1.Level1, D1.value1, 
	D2.dimId2, D2.dimension2, D2.LevelId2, D2.Level2, D2.value2,
	D3.dimId3, D3.dimension3, D3.LevelId3, D3.Level3, D3.value3
from DIM1 D1
